  ...
  return {
    ...
    remove: (id: string) =>
      db.transaction(async (tx) => {
        ...
        await tx.delete(issueCommentsReactions).where(eq(issueCommentsReactions.issueId, id));
        await tx.delete(costEvents).where(eq(costEvents.issueId, id));
        await tx.delete(issueRunAttempts).where(eq(issueRunAttempts.issueId, id));
        await tx.delete(issueSubscriptions).where(eq(issueSubscriptions.issueId, id));
